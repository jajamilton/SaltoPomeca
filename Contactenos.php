  ...
  <body>
    ...
    <div class="fondocont1">
        ...
        <header>
          ...
          <li><a href="Contactenos.php">Contactanos</a></li>
            ...
            <ul class="dropdown-menu">
              <li class="text-center"><a href="land.php?idk5=es" style="color: black">Español</a></li>
              <li class="text-center"><a href="land.php?idk5=in" style="color: black">Ingles</a></li>  
            </ul>
          </li>
          </ul>
        </header>
      ...
      <div class="col-lg-12 text-center">
        ...
        <h2 class="titulo1 visible-lg">Contactenos</h2>
        <h2 class="titulo2 hidden-lg">Contactenos</h2>
      ...
      <div class="col-lg-12 text-center">
        <div class="row">
          ...
          <div class="col-lg-5">
            ...
            <h3 class="subcontact"><i class="fas fa-map-marker-alt"></i>Ubicación</h3>

            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13445.933651471374!2d-73.55796572735467!3d5.892814252653316!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e41e1502218af2b%3A0xcf35069bfb017b6b!2sTierra+Castros%2C+Moniquir%C3%A1%2C+Boyac%C3%A1!5e1!3m2!1ses!2sco!4v1556163699015!5m2!1ses!2sco" width="400" height="300" frameborder="0" style="border:0" allowfullscreen></iframe>
          ...
          <!-- DATOS -->
          <div class="col-lg-5">
              <h3 class="subcontact"> Datos de contacto</h3>

              <!-- TELEFONO -->
              <div class="col-lg-12">
                <div class="col-xs-6 col-md-6 col-lg-6">
                  <div class="panel panel-default" style="border:0px;">
                      <div class="panel-heading" style="background: rgba(75,54,33,.8);">
                        <h4 style="color: #fff">Teléfono</h4>
                        <h5 style="color: #fff">7854745</h5>
                      </div>
                      <div class="panel-body">
                        <i class="fas fa-phone fa-3x" style="color: rgba(75,54,33,.8);"></i>
                      </div>
                  </div>
                </div>
                ...
                <div class="col-xs-6 col-md-6 col-lg-6">
                  <div class="panel panel-default" style="border:0px;">
                      <div class="panel-heading" style="background: rgba(75,54,33,.8);">
                        <h4 style="color: #fff">Celular</h4>
                        <h5 style="color: #fff">7854745</h5>
                      </div>
                      <div class="panel-body">
                        <i class="fas fa-mobile-alt fa-3x" style="color: rgba(75,54,33,.8);"></i>
                      </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-lg-12">
                ...
                <div class="col-xs-6 col-md-6 col-lg-6">
                  <div class="panel panel-default" style="border:0px;">
                      <div class="panel-heading" style="background: rgba(75,54,33,.8);">
                        <h4 style="color: #fff">Correo</h4>
                        <h5 style="color: #fff">7854745</h5>
                      </div>
                      <div class="panel-body">
                          <i class="fas fa-envelope fa-3x" style="color: rgba(75,54,33,.8);"></i>
                      </div>
                  </div>
                </div>
              </div>
      ...
      <div class="col-lg-12 text-center">
        <div class="row">
          ...
          <div class="col-lg-5" style="padding-top: 20px;">
            ...
            <h3 class="subcontact">Comments</h3>
          ...
          <!-- REDES SOCIALES -->
          <div class="col-lg-5">
            <h3 class="subcontact">Redes Sociales</h3>

            <!-- SECCION 1 -->
            <div class="col-lg-12">

                <!-- FACEBOOK -->
                <div class="col-xs-6 col-md-6 col-lg-6 hidden-lg">
                  <a href="">
                  <div class="panel panel-default" style="border:0px;">
                      <div class="panel-heading" style="background: #4c7338ff;">
                        <h4 style="color: #fff; font-size: 40px;">Facebook</h4>
                      </div>
                      <div class="panel-body">
                        <i class="fab fa-facebook-f fa-5x" aria-hidden="true" style="color: #4c7338ff"></i>
                      </div>
                  </div>
                  </a>
                </div>
                ...
                <!-- FACEBOOK MOVIL -->
                <div class="col-xs-12 col-md-12 col-lg-6 redes visible-lg" style="padding-right: 50px;">
                ...
                <div class="col-xs-6 col-md-6 col-lg-6 hidden-lg">
                  ...
                  <div class="panel panel-default" style="border:0px;">
                      <div class="panel-heading" style="background: #4c7338ff;">
                        <h4 style="color: #fff; font-size: 40px;">Twitter</h4>
                      </div>
                      <div class="panel-body">
                        <i class="fab fa-twitter fa-5x" aria-hidden="true" style="color: #4c7338ff"></i>
                      </div>
                  </div>
                  </a>
                </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="col-xs-6 col-md-6 col-lg-6 hidden-lg">
                  ...
                  <div class="panel panel-default" style="border:0px;">
                      <div class="panel-heading" style="background: #4c7338ff;">
                        <h4 style="color: #fff; font-size: 40px;">Instagram</h4>
                      </div>
                      <div class="panel-body">
                        <i class="fab fa-instagram fa-5x" aria-hidden="true" style="color: #4c7338ff"></i>
                      </div>
                  </div>
                  </a>
                </div>
                ...
                <div class="col-xs-6 col-md-6 col-lg-6 hidden-lg">
                  ...
                  <div class="panel panel-default" style="border:0px;">
                      <div class="panel-heading" style="background: #4c7338ff;">
                        <h4 style="color: #fff; font-size: 40px;">Tripadvisor</h4>
                      </div>
                      <div class="panel-body">
                        <i class="fab fa-tripadvisor fa-5x" aria-hidden="true" style="color: #4c7338ff"></i>
                      </div>
                  </div>
                  </a>
                </div>
